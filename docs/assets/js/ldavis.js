LDAvis = function(to_select, json_file) {
  ...
  // Style variables
  var colorBaseline = "#ffb15f"; // baseline color for default topic circles and overall term frequencies
  var colorHighlight = "#e57300"; // 'highlight' color for selected topics and term-topic frequencies
  var colorGrey = "#f1f1f1"; // background of controls

  var fontFamilySans = "'Helvetica Neue', sans-serif";
  ...
  var controlsStyle =
    ...
    "; width: " +
    mdswidth +
    "px; height: 50px; display: inline-flex; justify-content: center; align-items: center;";
  ...
  d3.json(json_file, function(error, data) {
    ...
    svg
      ...
      .style("text-anchor", "middle")
      .style("font-family", fontFamilySans);
    ...
    function init_forms(topicID, lambdaID, visID) {
      ...
      inputDiv.setAttribute(
        "style",
        "width: 100%; min-width: 1178px; display: flex; justify-content: space-between;"
      ); // to match the width of the main svg element
      document.getElementById(visID).appendChild(inputDiv);

      // topic input container:
      var topicDiv = document.createElement("div");
      topicDiv.setAttribute("class", "ldavis-controls");
      topicDiv.setAttribute("style", controlsStyle);
      topicDiv.setAttribute("style", "width: " + mdswidth + "px;");
      ...
      topicLabel.setAttribute(
        "style",
        "font-family: " + fontFamilySans + "; font-size: 14px"
      );
      ...
      topicInput.setAttribute("class", "ldavis-input");
      ...
      lambdaDiv.setAttribute("class", "ldavis-controls");
      lambdaDiv.setAttribute("style", "width: " + (mdswidth + 40) + "px;");
      ...
      sliderDiv.setAttribute(
        "style",
        "height: 40px; width: 250px; margin: -7px 20px 0;"
      );
      ...
      lambdaLabel.setAttribute(
        "style",
        "height: 20px; width: 60px; font-family: " +
          fontFamilySans +
          "; font-size: 14px;"
      );
    ...
    function topic_on(circle) {
      ...
      circle.style.fill = colorHighlight;
    ...
    function topic_off(circle) {
      ...
      circle.style.fill = colorBaseline;
